...
{
public:
	const int VersionDate = 202112101;
	...
	COLORREF Tx_MENU =			RGB(176, 144, 180);
	COLORREF Tx_MENU_CLONE =	RGB(166, 134, 170);
	COLORREF Tx_MENU_SEPARATOR =COLOR_GRAYTEXT;
	...
	COLORREF Bk_STATIC_STATS =  RGB(240, 240, 240);
