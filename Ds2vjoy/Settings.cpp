					...
					*value++ = 0;
					...
					for (int i = 0; i < MappingName::Mapping_Count; i++)
					{
						...
						case Mapping_Mouse:
							...
							break;
						case Mapping_Grid:
							btn.Grid[0] = max(0, min(65535, GridString(key, 0)));
							btn.Grid[1] = max(0, min(65535, GridString(key, 1)));
							btn.Grid[2] = max(0, min(65535, GridString(key, 2)));
							btn.Grid[3] = max(0, min(65535, GridString(key, 3)));
							btn.Grid[4] = max(0, min(65535, GridString(key, 4)));
							btn.Grid[5] = max(0, min(65535, GridString(key, 5)));
							break;
