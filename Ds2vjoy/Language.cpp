...
void LoadLanguage()
{
	...
	I18N.Button_LX_INV = GetText(IDS_BUTTON_LX_INV, L"AXISL X INV");
	I18N.Button_LY_INV = GetText(IDS_BUTTON_LY_INV, L"AXISL Y INV");
	I18N.Button_RX_INV = GetText(IDS_BUTTON_RX_INV, L"AXISR X INV");
	I18N.Button_RY_INV = GetText(IDS_BUTTON_RY_INV, L"AXISR Y INV");
