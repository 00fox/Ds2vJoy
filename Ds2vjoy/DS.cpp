...
void dsDevice::AssignOffsets()
{
	...
	if (tape.ActualDS == 2) m_buttons[dsButton::MUTE].setButton(m_receivedData + OffsetMute, 0b100);
	else m_buttons[dsButton::MUTE].setConstant(0);
	...
	m_buttons[dsButton::BATTERY].setData(m_receivedData + OffsetBatteryLevel, 0x0F);
}
